...
from CLIP4Clip.modules.until_module import PreTrainedModel, AllGather, CrossEn
from CLIP4Clip.modules.module_cross import CrossModel, CrossConfig, Transformer as TransformerClip

from CLIP4Clip.modules.module_clip import CLIP, convert_weights
...
class CLIP4Clip(CLIP4ClipPreTrainedModel):
    ...
    def loose_embedding(self, visual_output, video_mask, sim_header="meanP"):
